...
class ProductPagination extends StatelessWidget {
      ...
      builder: (context, state) {
        ...
        return Padding(
          ...
          child: Row(
            ...
            children: [
              _buildPerPageInfo(itemsPerPage),
              _buildPageControls(context, currentPage, totalPages, startItem, endItem, totalItems),
            ],
          ),
        );
      },
  ...
  Widget _buildPerPageInfo(int itemsPerPage) {
    return Row(
      children: [
      ...
      children: [
        ...
        IconButton(
            ...
            icon: Icon(Icons.chevron_right,
                color: currentPage < totalPages ? AppColors.slate500 : const Color(0xFFCBD5E1))),
      ],
    );
  }
