...
class ButtonStyles {
  ...
  static ButtonStyle posAction = ElevatedButton.styleFrom(
    ...
    foregroundColor: AppColors.white,
    elevation: 2,
    shadowColor: AppColors.success600.withValues(alpha: 0.3),
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.r)),
  ...
  static ButtonStyle paymentMethod = OutlinedButton.styleFrom(
    ...
    backgroundColor: AppColors.white,
    side: const BorderSide(color: AppColors.backgroundGrey6, width: 1.5),
    elevation: 0,
    shadowColor: Colors.transparent,
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12.r)),
  ...
  static ButtonStyle fab = ElevatedButton.styleFrom(
    ...
    foregroundColor: AppColors.white,
    elevation: 4,
    shadowColor: AppColors.primary600.withValues(alpha: 0.4),
